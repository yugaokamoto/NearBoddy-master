...
class FollowerViewController: UIViewController {
    ...
    func loadUser(){
        ...
        Api.Follow.fetchMyFollowers(userId: userId) { (key) in
...
extension FollowerViewController:PeopleTableViewCellDelegate{
    func goToProfileUserVC(userId: String) {
        performSegue(withIdentifier: "ProfileUserSegue", sender: userId)
    }
}

extension FollowerViewController:ProfileReuseableViewDelegate{
